...
class LTSFLinearClassifier(nn.Module):
    ...
    def __init__(self, input_channels=3, seq_length=1000, num_classes=38,
        ...
        # Classification head
        self.fc1 = nn.Linear(hidden_dim * input_channels, 256)
    ...
    def forward(self, x):
        ...
        # Store intermediate representation for get_latent
...
def create_ltsf_linear_model(input_channels, seq_length, num_classes, **kwargs):
    """
    Factory function to create LTSF-Linear model
...
def LTSFLinear(input_channels, seq_length, num_classes, **kwargs):
    """Alias for create_ltsf_linear_model"""
    return create_ltsf_linear_model(input_channels, seq_length, num_classes, **kwargs)
...
if __name__ == "__main__":
    ...
    model2 = create_ltsf_linear_model(
        input_channels=input_channels,
        seq_length=seq_length,
        num_classes=num_classes,
        dropout_rate=0.5,
    ...
    output2, attention2 = model2(x)
    print(f"Factory model output shape: {output2.shape}")
    
    print("LTSF-Linear model test completed successfully!")